...
<div class="slider banner">
  <img src="img/biograft_contacto_banner.png">
...
<div class="gray_bg biograft_tabs slider">
  	<div class="container gray_bg">
		<ul class="nav nav-tabs ">
		  <li><a show-tab href="#home" data-toggle="tab">Distribuidores</a></li>
		  <li><a show-tab href="#profile" data-toggle="tab">Hoja de Contacto</a></li>
		  <li><a show-tab href="#messages" data-toggle="tab">Bolsa de Trabajo</a></li>
		</ul>
	</div>
</div>
...
<div class="slider">
	...
	<div class="tab-content">
	  <div class="tab-pane active mb130" id="home">
	  	<h3 class="mt60">Distribuidores <br>
	  		<small>Contamos con varios distribuidores a su servicio:</small>
	  	</h3>
	  	<ul class="distribuidores">
	  		<li>Aplicaciones Medicas Integrales, S.A de C.V.</li>
	  		<li>Biomet 3i Mexico, S.A de C.V.</li>
	  		<li>Biomet Mexico, S.A. de C.V.</li>
	  		<li>Bruce Medica Internacional, S.A de C.V.</li>
	  		<li>CH Dental, S.A de C.V.</li>
	  		<li>Comercializadora Antel SA de CV</li>
	  		<li>COMERCIALIZADORA MEDICA MAVA, S.A. DE</li>
	  		<li>Corporativo Giormar de Mexico, S.A de C.V.</li>
	  		<li>EV Terapeutica, S.A de C.V.</li>
	  		<li>Gerardo Plascencia Gonzalez</li>
	  		<li>Grupo Ortomems, S.A de C.V.</li>
	  		<li>Hemost, S.A de C.V.</li>
	  		<li>Isomedica Supply, S.A de C.V.</li>
	  		<li>ISULMED S. DE R.L. DE C.V.</li>
	  		<li>Joaquin Avila Cajero</li>
	  		<li>Jorge Corral Quintero</li>
	  		<li>Lovimedic, S.A de C.V.</li>
	  		<li>MATCOM S.A de C.V</li>
	  		<li>Produmed, S.A de C.V.</li>
	  		<li>Tempo Medical, S.A de C.V.</li>
	  		<li>Traumaservice Internacional, S.A de C.V.</li>
	  	</ul>
	  </div>
