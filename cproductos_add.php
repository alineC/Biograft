...
if(!empty($arraycp[$i])){
	mysqli_query($con,"INSERT INTO cproductos (producto_id, cproducto) values ('".$_POST['producto_id']."','".$arraycp[$i]."')");
}
}
...
/* mysql_select_db($database_connection, $connection);
  ...
  */
   $insertGoTo = "cproductos_admin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right" valign="top">Código de producto:</td>
